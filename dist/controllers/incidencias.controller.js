...
exports.resumenIncidencias = exports.eliminarIncidencia = exports.actualizarIncidencia = exports.crearIncidencia = exports.listarIncidencias = void 0;
...
exports.listarIncidencias = listarIncidencias;
const crearIncidencia = async (req, res) => {
    try {
        const { trabajadorId, empresaId, sucursalId, cargoId, fecha, tipo, minutos, monto, observacion, } = req.body;
        ...
        const incidencia = await prisma_1.prisma.incidenciaAsistencia.create({
            data: {
...
const actualizarIncidencia = async (req, res) => {
    try {
        ...
        const existente = await prisma_1.prisma.incidenciaAsistencia.findUnique({
        ...
        const incidencia = await prisma_1.prisma.incidenciaAsistencia.update({
            where: { id: incidenciaId },
            data: {
                trabajadorId: trabajadorId !== undefined ? Number(trabajadorId) : existente.trabajadorId,
...
exports.actualizarIncidencia = actualizarIncidencia;
const eliminarIncidencia = async (req, res) => {
    try {
        ...
        await prisma_1.prisma.incidenciaAsistencia.delete({
            where: { id: incidenciaId },
        });
        return res.json({
            ok: true,
...
exports.eliminarIncidencia = eliminarIncidencia;
const resumenIncidencias = async (req, res) => {
    try {
...
exports.resumenIncidencias = resumenIncidencias;

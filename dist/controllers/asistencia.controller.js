...
exports.resumenAsistencia = exports.eliminarAsistencia = exports.actualizarAsistencia = exports.registrarAsistencia = exports.listarAsistencia = void 0;
    ...
    try {
        ...
        const registro = await prisma_1.prisma.asistencia.update({
            ...
            data: {
                ...
                horasExtras: horasExtras !== undefined ? Number(horasExtras) : existente.horasExtras,
...
const eliminarAsistencia = async (req, res) => {
    try {
        ...
        await prisma_1.prisma.asistencia.delete({ where: { id: asistenciaId } });
